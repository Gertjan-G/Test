  ...
  if (startDate && endDate && new Date(startDate) > new Date(endDate)) {
    ...
    switch (selectedDataset) {
        case 'dataset-Notariaat':
            ...
            loadNotariaatData(startDate, endDate, typesVastgoed, kiMin, kiMax, oppervlakteMin, oppervlakteMax, startBouwjaar, endBouwjaar);
            break;
        case 'dataset-Vlabel':
...
async function loadNotariaatData(startDate, endDate, typesVastgoed, kiMin, kiMax, oppervlakteMin, oppervlakteMax, startBouwjaar, endBouwjaar) {
  ...
  url += `ki_min=${kiMin}&ki_max=${kiMax}&opp_min=${oppervlakteMin}&opp_max=${oppervlakteMax}&start_bouwjaar=${startBouwjaar}&end_bouwjaar=${endBouwjaar}`;
  url = url.replace(/&$/, '');
